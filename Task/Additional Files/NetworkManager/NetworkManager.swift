...
public protocol Network {
    ...
    var tapsyrAPI: String { get set }
    var parametrs: String { get set }
...
public class NetworkManager: Network {
    ...
    public var url: String {
        get {
            return self.tapsyrAPI + self.parametrs
        }
    }
    
    public var tapsyrAPI: String = ""
    
    public var parametrs: String = ""
    ...
    public static func updateToken(_ complition: @escaping () -> Void) {
        ...
        self.postRequest("\(self.shared.tapsyrAPI)/api/v1/users/refresh", params: params) { (response) in
            guard let data = response.data else { return }
