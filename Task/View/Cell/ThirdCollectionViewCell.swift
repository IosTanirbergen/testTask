...
class ThirdCollectionViewCell: UICollectionViewCell {
    ...
    // MARK: - Properties
    lazy var cellImageView = UIImageView(image: #imageLiteral(resourceName: "3").withRenderingMode(.alwaysOriginal))
    ...
    func configureView() {
        ...
        titleLabel.configureLabel(text: AppKeys.Strings.thirdTitle, textColor: .black, textAlignment: .center, fontName: "AppleSDGothicNeo-UltraLight", fontSize: 20, numberOfLines: 0)
        subtitleLabel.configureLabel(text: AppKeys.Strings.thirdSubtitle, textColor: .lightGray, textAlignment: .center, fontName: "AppleSDGothicNeo-UltraLight", fontSize: 16, numberOfLines: 0)
    }
