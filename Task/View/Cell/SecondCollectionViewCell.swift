...
class SecondCollectionViewCell: UICollectionViewCell {
    ...
    // MARK: - Properties
    lazy var cellImageView = UIImageView(image: #imageLiteral(resourceName: "2").withRenderingMode(.alwaysOriginal))
    ...
    func configureView() {
        ...
        titleLabel.configureLabel(text: AppKeys.Strings.secondTitle, textColor: .black, textAlignment: .center, fontName: "AppleSDGothicNeo-UltraLight", fontSize: 20, numberOfLines: 0)
        subtitleLabel.configureLabel(text: AppKeys.Strings.secondSubtitle, textColor: .lightGray, textAlignment: .center, fontName: "AppleSDGothicNeo-UltraLight", fontSize: 16, numberOfLines: 0)
    }
